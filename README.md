...
A fault tolerant replicated KV store built on the Raft consensus protocol in Go. Implements leader election, log replication, crash safe persistence, snapshot compaction, and linearizable state machine replication.
...
The RPC simulation layer, serialization helpers, and tester harness were provided by the course.
